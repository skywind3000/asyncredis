...
class AsyncRedis (object):
	...
	def __init__ (self, on_reply, on_start = None, on_estab = None, on_close = None):
...
class RedisClient (object):
	...
	def __init__ (self, reply, subscribe, timer, heartbeat = 5):
		self.__redis1 = AsyncRedis(self.__normal_reply, self.__normal_start)
		self.__redis2 = AsyncRedis(self.__subscribe_reply, self.__subscribe_start)
...
if __name__ == '__main__':
	...
	def test2():
		...
		c = AsyncRedis(on_reply, on_start, on_estab, on_close)
	...
	def test3():
		...
		def on_timer (r):
			...
			r.count += 1
		rc = RedisClient(on_reply, on_subscribe, on_timer)
